...
if "WHEN COALESCE(p.games_current_season, 0) > 0" in content:
    ...
    new_content = new_content.replace(old_from, new_from)
    ...
    print("")
    print("Now restart your Flask backend and try the Fantrax upload!")
